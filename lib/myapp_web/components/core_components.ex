defmodule MyappWeb.CoreComponents do
  ...
  @doc """
  Renders a modal overlay. Clicking the backdrop triggers the on_click event.
  """
  attr :on_click, :string, required: true, doc: "phx-click event when backdrop is clicked"
  slot :inner_block, required: true
